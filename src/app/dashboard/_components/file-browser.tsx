    ...
    <div>
      ...
      <Tabs defaultValue="grid">
        <div className="  flex flex-row  gap-2 justify-between items-center">
          <TabsList >
            <TabsTrigger value="grid" className="flex gap-3 items-center">
              <GridIcon />
              Grid
            </TabsTrigger>
            <TabsTrigger value="table" className="flex gap-3 items-center">
              <RowsIcon /> Table
            </TabsTrigger>
          </TabsList>
          ...
          <div className="flex  items-center">
            ...
            >
              <SelectTrigger id="type-select" className="w-[108px] ">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
